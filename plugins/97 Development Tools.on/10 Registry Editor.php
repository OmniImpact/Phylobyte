...
<strong>Registries</strong>
	<form action="?'.$_SERVER['QUERY_STRING'].'" method="POST" style="text-align: center;">
...
$leftcol.=('<dt>['.$selchar.'] | <a href="?'.$_SERVER['QUERY_STRING'].'&amp;REGDROP='.$registry['name'].'">&times;</a>
 | <a href="?'.$_SERVER['QUERY_STRING'].'&amp;REG='.$registry['name'].'">'.$registry['name'].'</a></dt>
');
}
$leftcol.='
</dl>
...
<strong>Registry Entries</strong><br/>
	<form action="?'.$_SERVER['QUERY_STRING'].'&amp;REG='.$_GET['REG'].'" method="POST" style="text-align: center; width: 99.4%; margin-bottom: 6pt;">
...
'.$TR->pull("<tr><td>%i%</td><td>%k%</td><td>%v%</td><td style=\"text-align: center;\"><a href=\"?{$_SERVER['QUERY_STRING']}&amp;REG={$_GET['REG']}&amp;DEL=%i%\">&times;</a></td></tr>").'</table>';
