	...
	**/
	...
	class Folder {
		...
		function Folder($path) {
			...
			$this -> folders 	= array();
			$this -> files		= array();
			$this -> exclude_extensions = array('gif', 'jpg', 'jpeg', 'png', 'tft', 'bmp', 'rest-of-the-file-extensions-to-exclude', 'js', 'bak');
			$this -> exclude_files 	    = array('countme.php', 'rest-of-the-files-to-exclude');
			$this -> exclude_folders 	 = array('_private', '_vti_bin', '_vti_cnf', '_vti_log', '_vti_pvt', '_vti_txt', 'rest-of-the-folders-to-exclude', 'resources', 'data', 'gfx', 'images');
		}
